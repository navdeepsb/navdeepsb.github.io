...
export default class Lusie extends OneParentForThemAll {
    render() {
        let bannerData = {
            projName: "Lusie",
        ...
        return (
            <div className="project">
                ...
                <p style={{ textAlign: "right" }}><a href="https://cdn.rawgit.com/navdeepsb/lusie/master/index.html" rel="nofollow" target="_blank" tabIndex="-1" title="Open Lusie in new tab">Open Lusie in a new tab</a></p>
