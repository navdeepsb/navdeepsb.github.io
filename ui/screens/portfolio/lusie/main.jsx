        ...
        return (
            <div className="project">
                ...
                <div className="content-block">
                    <h4>Why?</h4>
                    <p>
                        A popular pass time among my family was to play housie on the weekends. Housie involves one player, the moderator, to draw numbers randomly from a pool of chips numbered 1-90 and places them on a physical board to keep track of the numbers drawn. The other players get a stub with random numbers on them. As the moderator calls out the number, the players strike off a number if it matches the number drawn. Prices are won on the basis of certain rules like striking all the numbers in one row, striking the first sever numbers and so on.
                        <br /><br />
